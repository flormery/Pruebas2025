        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES'){
                    git branch: 'main', credentialsId: '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', url: 'https://github.com/flormery/Pruebas2025.git'
                }
            }
        }
        stage('Build') {
